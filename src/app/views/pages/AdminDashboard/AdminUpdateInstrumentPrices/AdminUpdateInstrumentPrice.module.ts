...
import { AdminUpdateInstrumentPrice } from './AdminUpdateInstrumentPrice.component';
import {} from './AdminUpdateInstrumentPrice.component'
...
const routes: Routes = [
  {
    path: '',
    component: AdminUpdateInstrumentPrice
  }
]
...
@NgModule({
  declarations: [AdminUpdateInstrumentPrice],
  imports: [
    CommonModule,
