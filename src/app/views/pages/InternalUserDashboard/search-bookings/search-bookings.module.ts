...
const routes: Routes = [
  {
    path: '',
    component: SearchBookingsComponent // Route to the new bookings component
  }
];

@NgModule({
  declarations: [
    SearchBookingsComponent // Declare the new bookings component
  ],
  imports: [
    CommonModule,
...
export class SearchBookingsModule {}