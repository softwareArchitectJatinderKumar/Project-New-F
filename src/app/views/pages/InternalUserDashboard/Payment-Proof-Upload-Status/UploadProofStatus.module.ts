...
const routes: Routes = [
  {
    path: '',
    component: UploadProofStatusComponent // Route to the new bookings component
  }
];

@NgModule({
  declarations: [
    UploadProofStatusComponent // Declare the new bookings component
  ],
  imports: [
    CommonModule,
...
export class UploadProofStatusModule {}