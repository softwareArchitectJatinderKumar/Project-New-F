...
const routes: Routes = [
  {
    path: '',
    component: NewBookingsComponent // Route to the new bookings component
  }
];

@NgModule({
  declarations: [
    NewBookingsComponent // Declare the new bookings component
  ],
  imports: [
    CommonModule,
...
export class NewBookingsModule {}