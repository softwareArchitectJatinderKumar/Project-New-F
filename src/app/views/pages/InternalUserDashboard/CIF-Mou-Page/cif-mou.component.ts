...
// @Component({
//   selector: 'cif-mou',
//   templateUrl: './cif-mou.component.html',
//   styleUrls: ['./cif-mou.component.scss'],
// })
// export class cifMouComponent implements OnInit, OnDestroy {
...
//       this.cifEmail    = c.EmailId       ?? '';
//       this.cifName     = c.CandidateName ?? '';
...
//         loginName: this.cifEmail,          // FIX 5: now always populated from cookie
//       };
